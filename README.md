...
git clone https://github.com/your-username/api-invoice-ocr.git
cd api-invoice-ocr
...
- **Base URL**: http://localhost:8080/v1/invoice/
...
```bash
curl -H "Authorization: Bearer dev-invoice-key" \
     http://localhost:8080/v1/invoice/endpoint
```
...
curl -H "X-RapidAPI-Proxy-Secret: your-secret" \
     ...
     https://your-api.p.rapidapi.com/v1/invoice/endpoint
```
...
```bash
# Build image
docker build -t api-invoice-ocr .

# Run container
docker run -p 8080:8080 \
  -e INVOICE_OCR_API_KEY=your-key \
...
2. Repository: `your-username/api-invoice-ocr`
...
| `INVOICE_OCR_API_KEY` | Service API key | dev-invoice-key |
...
INVOICE_OCR_API_KEY=your-development-key
```
...
INVOICE_OCR_API_KEY=your-production-api-key
...
2. **Docker Build Issues**
   ...
   docker build --no-cache -t api-invoice-ocr .
   ```
...
### Base URL
```
http://localhost:8080/v1/invoice/
```
